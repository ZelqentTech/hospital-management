...
export function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    socket.on('new_appointment', (appt: any) => {
      ...
      setStats((prev: any) => ({ ...prev, appointments: prev.appointments + 1 }));
    });
  ...
  const dashboardStats = [
    { label: 'Total Revenue', value: `$${stats.revenue.toLocaleString()}`, change: '+12.5%', icon: CreditCard, color: 'text-green-600', bg: 'bg-green-100', trend: TrendingUp },
    { label: 'Active Doctors', value: stats.doctors.toString(), change: '+3%', icon: Users, color: 'text-primary', bg: 'bg-primary/10', trend: TrendingUp },
    { label: 'Total Patients', value: stats.patients.toLocaleString(), change: '+8%', icon: Users, color: 'text-blue-600', bg: 'bg-blue-100', trend: TrendingUp },
  ];
